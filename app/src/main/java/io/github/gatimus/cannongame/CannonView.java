...
public class CannonView extends SurfaceView implements SurfaceHolder.Callback{
   ...
   private SparseIntArray soundMap;//private Map<Integer, Integer> soundMap; // maps IDs to SoundPool
   ...
   public CannonView(Context context, AttributeSet attrs){
      ...
      soundMap = new SparseIntArray();//new HashMap<Integer, Integer>(); // create new HashMap
      ...
      while (retry){
         try{
            ...
            retry = false;
                 ...
                 Log.e(getClass().getSimpleName(), barrelEnd.toString());
         } // end catch
      } // end while
